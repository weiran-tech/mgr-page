...
@section('backend-main')
    ...
    --}}
    <!-- 控制开关 -->
        <div class="layui-form" style="margin: 25px 0;display: none;">
    ...
    layui.use(['layer', 'form', 'admin'], function() {
        ...
        for (var i = 0; i < themes.length; i++) {
            ...
            str += '      <img src="/assets/libs/easy-web/module/theme/img/theme-' + themes[i].theme + '.png">';
            str += '   </div>';
